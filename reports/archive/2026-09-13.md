...
保存済み集計日（UTC）：2026-09-13
判定確認日（UTC）：2026-09-13

## Bitcoin
- BTC：77,265 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：62.43 / 100
- Top Risk（参考値）：0.26 / 100
...
- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-12
