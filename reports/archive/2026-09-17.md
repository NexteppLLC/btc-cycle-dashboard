...
保存済み集計日（UTC）：2026-09-17
判定確認日（UTC）：2026-09-17

## Bitcoin
- BTC：76,146 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：57.48 / 100
...
## Gold
- 保存済み集計日（UTC）：2026-09-17
- 価格：4,387.50 USD（現物・先物・ETF代理値の区別はソース参照）
...
## Silver
- 保存済み集計日（UTC）：2026-09-17
- 価格：64.29 USD（現物・先物・ETF代理値の区別はソース参照）
- フェーズ：DISTRIBUTION / 分配局面
...
- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-16
- gold_price_usd：OK · Yahoo Finance GC=F / FUTURES_PROXY / 2026-09-16
- silver_price_usd：OK · Yahoo Finance SI=F / FUTURES_PROXY / 2026-09-16
- global_mvrv：OK
