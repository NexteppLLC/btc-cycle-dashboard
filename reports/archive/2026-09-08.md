...
保存済み集計日（UTC）：2026-09-08
判定確認日（UTC）：2026-09-08

## Bitcoin
- BTC：79,090 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：62.48 / 100
- Top Risk（参考値）：3.65 / 100
...
- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-07
