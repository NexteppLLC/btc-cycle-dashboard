...
保存済み集計日（UTC）：2026-09-20
判定確認日（UTC）：2026-09-20

## Bitcoin
- BTC：81,226 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：48.36 / 100
- Top Risk（参考値）：5.86 / 100
...
- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-19
