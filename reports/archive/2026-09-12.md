...
保存済み集計日（UTC）：2026-09-12
判定確認日（UTC）：2026-09-12

## Bitcoin
- BTC：77,211 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：62.35 / 100
- Top Risk（参考値）：0.29 / 100
...
## Gold
- 保存済み集計日（UTC）：2026-09-12
- 価格：4,366.20 USD（現物・先物・ETF代理値の区別はソース参照）
...
- フェーズ：DISTRIBUTION / 分配局面
- Institutional Demand：52.60 / 100
- Top Risk：58.80 / 100
- Dip Quality：44.40 / 100
- Confidence：100.0%

## データの状態
更新結果：一部取得不可

- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-11
