...
保存済み集計日（UTC）：2026-09-10
判定確認日（UTC）：2026-09-10

## Bitcoin
- BTC：78,289 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：63.30 / 100
- Top Risk（参考値）：2.19 / 100
...
## Gold
- 保存済み集計日（UTC）：2026-09-10
- 価格：4,416.00 USD（現物・先物・ETF代理値の区別はソース参照）
- フェーズ：DISTRIBUTION / 分配局面
- Institutional Demand：70.20 / 100
- Top Risk：61.60 / 100
...
## Silver
- 保存済み集計日（UTC）：2026-09-10
- 価格：67.94 USD（現物・先物・ETF代理値の区別はソース参照）
- フェーズ：DISTRIBUTION / 分配局面
- Institutional Demand：55.60 / 100
- Top Risk：34.50 / 100
- Dip Quality：42.00 / 100
- Confidence：100.0%

## データの状態
更新結果：一部取得不可

- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-09
- gold_price_usd：OK · Yahoo Finance GC=F / FUTURES_PROXY / 2026-09-09
- silver_price_usd：OK · Yahoo Finance SI=F / FUTURES_PROXY / 2026-09-09
- global_mvrv：OK
