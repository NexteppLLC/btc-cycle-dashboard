...
保存済み集計日（UTC）：2026-09-18
判定確認日（UTC）：2026-09-18

## Bitcoin
- BTC：76,355 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：57.41 / 100
...
## Gold
- 保存済み集計日（UTC）：2026-09-18
- 価格：4,399.70 USD（現物・先物・ETF代理値の区別はソース参照）
...
## Silver
- 保存済み集計日（UTC）：2026-09-18
- 価格：65.47 USD（現物・先物・ETF代理値の区別はソース参照）
- フェーズ：DISTRIBUTION / 分配局面
...
- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-17
- gold_price_usd：OK · Yahoo Finance GC=F / FUTURES_PROXY / 2026-09-17
- silver_price_usd：OK · Yahoo Finance SI=F / FUTURES_PROXY / 2026-09-17
- global_mvrv：OK
