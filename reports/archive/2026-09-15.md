...
保存済み集計日（UTC）：2026-09-15
判定確認日（UTC）：2026-09-15

## Bitcoin
- BTC：78,193 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：65.42 / 100
- Top Risk（参考値）：1.56 / 100
...
## Gold
- 保存済み集計日（UTC）：2026-09-15
- 価格：4,351.90 USD（現物・先物・ETF代理値の区別はソース参照）
...
## Silver
- 保存済み集計日（UTC）：2026-09-15
- 価格：63.51 USD（現物・先物・ETF代理値の区別はソース参照）
- フェーズ：DISTRIBUTION / 分配局面
...
- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-14
- gold_price_usd：OK · Yahoo Finance GC=F / FUTURES_PROXY / 2026-09-14
- silver_price_usd：OK · Yahoo Finance SI=F / FUTURES_PROXY / 2026-09-14
- global_mvrv：OK
