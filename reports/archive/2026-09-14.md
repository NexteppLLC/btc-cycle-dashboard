...
保存済み集計日（UTC）：2026-09-14
判定確認日（UTC）：2026-09-14

## Bitcoin
- BTC：76,800 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：62.59 / 100
- Top Risk（参考値）：0.00 / 100
...
## Gold
- 保存済み集計日（UTC）：2026-09-14
- 価格：4,408.90 USD（現物・先物・ETF代理値の区別はソース参照）
- フェーズ：DISTRIBUTION / 分配局面
- Institutional Demand：42.40 / 100
- Top Risk：73.60 / 100
...
## Silver
- 保存済み集計日（UTC）：2026-09-14
- 価格：64.55 USD（現物・先物・ETF代理値の区別はソース参照）
- フェーズ：DISTRIBUTION / 分配局面
- Institutional Demand：47.60 / 100
- Top Risk：58.80 / 100
- Dip Quality：40.60 / 100
- Confidence：100.0%

## データの状態
更新結果：一部取得不可

- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-13
- gold_price_usd：OK · Yahoo Finance GC=F / FUTURES_PROXY / 2026-09-11
- silver_price_usd：OK · Yahoo Finance SI=F / FUTURES_PROXY / 2026-09-11
- global_mvrv：OK
