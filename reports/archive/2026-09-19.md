...
保存済み集計日（UTC）：2026-09-19
判定確認日（UTC）：2026-09-19

## Bitcoin
- BTC：80,878 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：55.64 / 100
- Top Risk（参考値）：5.43 / 100
...
- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-18
