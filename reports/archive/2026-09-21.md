...
判定確認日（UTC）：2026-09-21

## Bitcoin
- BTC：81,164 USD
- フェーズ：判定保留 / PARTIAL
- Cycle Score（参考値）：38.16 / 100
- Top Risk（参考値）：5.69 / 100
...
- STH-MVRV：取得不可 · 観測日 2026-09-21 · Status UNAVAILABLE_NO_API_KEY
- STH-SOPR：取得不可 · 観測日 2026-09-21 · Status UNAVAILABLE_NO_API_KEY
- LTH-MVRV：取得不可 · 観測日 2026-09-21 · Status UNAVAILABLE_NO_API_KEY
- LTH Distribution：取得不可 · 観測日 取得不可 · Status UNAVAILABLE
- Sell-Side Risk 15日SMA：取得不可 · 観測日 2026-09-21 · Status UNAVAILABLE_NO_API_KEY · 理由 Sell-Side input request unavailable
...
## Gold
- 保存済み集計日（UTC）：2026-09-21
- 価格：4,424.90 USD（現物・先物・ETF代理値の区別はソース参照）
...
- btc_price_usd：OK · Kraken Spot XBT/USD daily OHLC / SPOT / 2026-09-20
- gold_price_usd：OK · Yahoo Finance GC=F / FUTURES_PROXY / 2026-09-18
- silver_price_usd：OK · Yahoo Finance SI=F / FUTURES_PROXY / 2026-09-18
- global_mvrv：OK
